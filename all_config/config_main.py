...
parser.add_argument('--gpu', type=str, default='1', help='train use gpu')
...
parser.add_argument('--warmup_iteration', type=int, default=-1)
...
parser.add_argument('--train_mode', type=str, default="main_training",
                    help='pretraining | main_training')
parser.add_argument('--ifcut', type=bool, default=True)
parser.add_argument('--cps_weight', type=float, default=2)
...
parser.add_argument('--repo_name', type=str, default="mymodel")
...
config.backup = ['all_config/config_main.py']
